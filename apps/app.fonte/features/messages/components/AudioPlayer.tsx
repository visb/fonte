...
const ACCENT_OWN = '#ede9fe';
const ACCENT_OTHER = '#7c3aed';
const TRACK_OWN = 'rgba(255,255,255,0.25)';
const TRACK_OTHER = '#e5e7eb';

export function AudioPlayer({ url, isMine }: Props) {
  ...
  const accent = isMine ? ACCENT_OWN : ACCENT_OTHER;
  const trackBg = isMine ? TRACK_OWN : TRACK_OTHER;
