...
/**
 * Uma linha de contribuição em produtos no formulário de declaração (story 114).
 *
...
/** Formulário completo de declaração: ao menos uma linha. */
export const productContributionFormSchema = z.object({
  products: z.array(productLineSchema).min(1, 'Adicione ao menos um produto'),
});

export type ProductContributionFormValues = z.infer<typeof productContributionFormSchema>;
