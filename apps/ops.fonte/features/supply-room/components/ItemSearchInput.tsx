...
type Props = {
  ...
  selectedItem?: SupplyRoomItem;
  items: SupplyRoomItem[];
  onChangeText: (text: string) => void;
  onSelect: (item: SupplyRoomItem) => void;
  onConfirmNewItem: (unit: string, category: SupplyRoomCategory) => void;
...
export function ItemSearchInput({
  ...
  function handleSelect(item: SupplyRoomItem) {
    onSelect(item);
  ...
  function handleConfirmNewItem(unit: string, category: SupplyRoomCategory) {
    onConfirmNewItem(unit, category);
    setShowNewItemForm(false);
  }
