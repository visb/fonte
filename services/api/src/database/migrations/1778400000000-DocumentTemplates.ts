...
export class DocumentTemplates1778400000000 implements MigrationInterface {
  name = 'DocumentTemplates1778400000000';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
      CREATE TYPE "public"."document_templates_type_enum"
        AS ENUM('IMAGE_AUTHORIZATION', 'COMMUNITY_RULES', 'FAMILY_RULES')
    `);

    await queryRunner.query(`
      CREATE TABLE "document_templates" (
        "id"         uuid        NOT NULL DEFAULT uuid_generate_v4(),
        "type"       "public"."document_templates_type_enum" NOT NULL,
        "content"    text        NOT NULL,
        "updated_at" TIMESTAMP   NOT NULL DEFAULT now(),
        CONSTRAINT "PK_document_templates" PRIMARY KEY ("id"),
        CONSTRAINT "UQ_document_templates_type" UNIQUE ("type")
      )
    `);
    ...
    await queryRunner.query(`
      CREATE TABLE "resident_documents" (
        ...
        CONSTRAINT "UQ_resident_documents_resident_type" UNIQUE ("resident_id", "type"),
    ...
    await queryRunner.query(
      `INSERT INTO "document_templates" ("type", "content") VALUES ($1, $2), ($3, $4), ($5, $6)`,
      [
        'IMAGE_AUTHORIZATION', IMAGE_AUTHORIZATION_HTML,
        'COMMUNITY_RULES', COMMUNITY_RULES_HTML,
        'FAMILY_RULES', FAMILY_RULES_HTML,
      ],
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`DROP TABLE "resident_documents"`);
